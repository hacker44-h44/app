...
I'm BHH api bot, an administration bot using the official Bot API.
...
For a correct use of the markdown, ask from  [support group](https://telegram.me/joinchat/C9SSWkEu_-m1xonWcAOVXA)
...
`$rules`: _will be replaced by a link to the rules of the group.
...
*Note:* the markdown is supported. If the text sent breaks the markdown, the bot will notify that something is wrong.
For a correct use of the markdown, check [support group](https://telegram.me/joinchat/C9SSWkEu_-m1xonWcAOVXA)
